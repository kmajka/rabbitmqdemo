...
@Component
public class RabbitDeadLetterMessageConsumer {

    private final MessageConverter converterForHeaderExchange;

    public RabbitDeadLetterMessageConsumer(@Qualifier(CONVERTER_FOR_HEADER_EXCHANGE) MessageConverter converterForHeaderExchange) {
